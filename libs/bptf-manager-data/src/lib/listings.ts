...
export const DESIRED_LISTINGS_CLEAR_PATH = `${DESIRED_LISTINGS_PATH}/all`;
...
export const DESIRED_LISTINGS_CLEAR_FULL_PATH =
  LISTINGS_BASE_URL + DESIRED_LISTINGS_CLEAR_PATH;
